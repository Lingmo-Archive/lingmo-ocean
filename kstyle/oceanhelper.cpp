    ...
    void Helper::renderDecorationButton( QPainter* painter, const QRect& rect, const QColor& color, ButtonType buttonType, bool inverted ) const
    {
        ...
        switch( buttonType )
        {
            ...
            case ButtonMaximize:
            {
                ...
                painter->drawLine( 4, 6, 4, 13 );
                painter->drawLine( 14, 6, 14, 13 );
                break;
            }
            ...
            case ButtonRestore:
            {
                ...
                painter->drawLine( 14, 4, 14, 10 );
                painter->drawLine( 8, 10, 14, 10 );
                painter->drawLine( 4, 6, 4, 13 );
                painter->drawLine( 4, 13, 10, 13 );
                painter->drawLine( 4, 6, 5.6, 6 );
                painter->drawLine( 10, 11.4, 10, 13 );
                break;
            }
